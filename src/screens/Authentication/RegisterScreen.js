    ...
    return (
        <Container>
            <View style={Style.setheaderspacepadding}>
                <AppHeader leftImage={'arrowleft'} title={Strings.login.register} onLeftPress={() => navigation.navigate(RouteName.LOGIN_SCREEN)} />
            </View>
            <ScrollView
                ...
                <View style={[Styles.container, { backgroundColor: colorsset.BackgroundColorScreen }]}>
                    <View style={Style.minviewallcontent}>
                        ...
                        <Text style={Styles.textStyle}>{Strings.register.already_have_an_account} <Text style={Styles.registerTextStyle} onPress={() => OnLoginPresslogin()}>{Strings.login.login}</Text></Text>
                    </View>
                    <View style={Style.centeredView}>
                        {DisplayAlert !== 0 ?
                            <Alert message='Registration Successfull' link={RouteName.REGIATRAION_SUCCESSFULL} buttonText={Styles.WhiteText} />
                            :
                            null
                        }
                    </View>
